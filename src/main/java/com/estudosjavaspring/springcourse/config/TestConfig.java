...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Course c1 = new Course(null, "Desenvolvimento Web Full Stack", "Aprenda a criar aplicações web completas do front-end (React) ao back-end (Node.js e API REST).", 997.50, null);
        Course c2 = new Course(null, "Análise de Dados com Python e Pandas", "Domine as bibliotecas Python para manipulação, limpeza e visualização de grandes volumes de dados.", 450.00, null);
        Course c3 = new Course(null, "Estratégias Avançadas de Marketing Digital", "Crie campanhas eficazes de SEO, tráfego pago (Google Ads) e otimização de funis de conversão.", 399.90, null);
